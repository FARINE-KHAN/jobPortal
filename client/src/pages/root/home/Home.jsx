...
function Home() {
  ...
  const jobSeeker=useSessionData("user");
  return (
    <div className="home">
      <div className="header flex flex-col justify-center items-center w-100 gap-6">
        ...
        <div className="buttons flex gap-10">
          <Button onClick={()=>{jobSeeker?navigate("/job-seeker/dashboard"):navigate("/job-seeker/login")}} color="primary" variant="shadow" className="p-6">
            Find Jobs
          </Button>
      ...
      <div className="end-section w-100 flex flex-col items-center gap-5">
        ...
        <Button color="primary" variant="shadow" className="p-6" onClick={()=>{jobSeeker?navigate("/job-seeker/dashboard"):navigate("/job-seeker/login")}} >Get Started</Button>
      </div>
      <Footer />
    </div>
  );
